...
(def lib 'com.github.brettatoms/darkstar)
...
(defn- pom-template [version]
  [[:description "Datastar binding for remuda"]
   [:url "https://github.com/brettatoms/darkstar"]
   [:licenses
    [:license
     [:name "MIT License"]
   ...
   [:scm
    [:url "https://github.com/brettatoms/darkstar"]
    [:connection "scm:git:https://github.com/brettatoms/darkstar.git"]
    [:developerConnection "scm:git:ssh:git@github.com:brettatoms/darkstar.git"]
    [:tag (str "v" version)]]])
